...
<template>
    <div class="final h-screen">
        ...
        <div class="absolute bottom-0 left-50% translate-x-[-50%]">
            <img :src="`/img/characters/pushkin 5.png`" class=" w-100% h-144% lt-xxxl:min-w-460px lt-xxxl:w-460px absolute bottom-0 left-[-130px] lt-lg:left-[-140px] lt-xxxl:left-0 z-1" >
            <div class="w-600px  lt-sm:w-284px  lt-lg:w-420px flex flex-col p-42px lt-lg:p-24px bg-white q-shadow-md__light-green relative z-2 mb-142px">
                ...
                <p class="font-400 text-26px lt-xxxl:text-18px leading-130% text-black mt-24px lt-lg:mt-18px lt-lg:w-236px">Не расстраивайся, ты можешь пройти квиз заново и проверить свои знания</p>
